...
export const userOrders = [
  {
    ...
    addressIfS: "Address of giver",
    transLocalStart: "Transaction location start",
    transAddress: "Cau Giay, Hanoi",
    gatherAddress: "Xuan Thuy",
    transLocalEnd: "Transaction location end",
    gatherLocaStart: "Gather location Start",
    gatherLocaEnd: "Gather location End",
    timeTransStart: null,
  ...
  },
  {
    ...
    addressIfS: "Address of giver",
    transLocalStart: "Transaction location start",
    transAddress: "Thanh Xuan, Hanoi",
    gatherAddress: "Khuong Dinh",
    transLocalEnd: "Transaction location end",
    gatherLocaStart: "Gather location Start",
    gatherLocaEnd: "Gather location End",
    timeTransStart: null,
    ...
    giverName: "Mai Trang",
    giverPhone: "0123456789",
    receiverName: "Anh Duong",
    receiverPhone: "0987654321",
    transacStaffName: "Shipper A",
  },
  {
    idOrder: "#875hje",
    name: "Order Name 3",
    ...
    addressIfS: "Address of giver",
    transLocalStart: "Transaction location start",
    transAddress: "Thanh Thuy, Thai Binh",
    gatherAddress: "Mai Dich, Cau Giay",
    transLocalEnd: "Transaction location end",
    gatherLocaStart: "Gather location Start",
    gatherLocaEnd: "Gather location End",
    timeTransStart: null,
    ...
    isDeliveSuccess: false,
    status: OrderStatus.atStartGatherLocal,
    giverName: "Nguyen Van A",
    giverPhone: "0123456789",
    receiverName: "Nguyen Van B",
    receiverPhone: "0987654321",
    transacStaffName: "Nguyen Van C",
  },
  {
    idOrder: "#abh678",
    name: "Order Name 4",
  ...
  },
  {
    ...
    addressIfS: "Address of giver",
    transLocalStart: "Transaction location start",
    transAddress: "Thanh Thuy, Hoa Binh",
    gatherAddress: "Thanh pho Hoa Binh",
    transLocalEnd: "Transaction location end",
    gatherLocaStart: "Gather location Start",
    gatherLocaEnd: "Gather location End",
    timeTransStart: null,
